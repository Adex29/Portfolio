                    ...
                    <div className='basis-1/2 z-40 relative contact-container lg:shrink'>
                        <center>
                            ...
                            <form className='form-control w-3/4'>
                                    ...
                                    <textarea className="textarea textarea-bordered m-2" placeholder="Message"></textarea>
            ...
            <dialog id="my_modal_5" className="modal modal-bottom sm:modal-middle">
                <div className="modal-box">
                    ...
                    <hr className="w-full border-black " /> 
                        ...
                        <h6 onClick={() => window.open("https://www.linkedin.com/in/jay-ar-b-6a7343128/")} className="text-2xl m-5"><strong><a className='link link-hover' href="https://www.linkedin.com/in/jay-ar-b-6a7343128/">View Resume</a></strong></h6>
                    </center>
